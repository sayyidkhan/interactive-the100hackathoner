...
/* The live source streams a colocated Three.js vendor module with progress.
   This reconstruction uses the repository's pinned dependency instead. */
...
const LINKS = {
  ...
  'c-resume': 'https://kairui.dev/resume.pdf',
